...
store.innerHTML = "V&S Furniture";
mobile.innerHTML = store.innerHTML; 

//sets the address at the top of the page
var add = document.getElementById("address");
add.innerHTML = "1024 6th St | Los Banos, CA 93635 | (209) 827-1609";

//sets the copyright at bottom of page
var copyright = document.getElementById("copyright");
copyright.innerHTML = "Copyright &copy; V&S Furniture 2016";

var contact = document.getElementById("contact");
//sets the title
document.title  = "V&S Furniture";

//sets Facebook link
document.getElementById("fb").href = "https://www.facebook.com/VS-Furniture-246818825396263/";
